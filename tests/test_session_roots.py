"""S1 «Solid Core»: корені сесії мусять бути канонізованими.

core.scan() нормалізує корені (realpath, дедуп) всередині, але викидає
результат; воркери писали в сесію СИРІ шляхи. Скан через симлінк давав
сесію, що не проходила containment-валідацію при завантаженні.
"""
