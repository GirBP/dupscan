"""F3: злиття не ламається на файлах, яких скан не охопив.

Дзеркало реального кейсу власника: профіль із min_size=1 МіБ, тека-копія з
одним унікальним великим файлом і багатьма малими. Раніше малі файли не мали
класу, тому крок Кошика відмовляв («N файлів без живої копії»).
"""
